...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        listPopular.add(PopularModel(R.drawable.recycrelimage1,"Aloe Vera",2179,2179,1))
        listPopular.add(PopularModel(R.drawable.recycrelimage2,"Beauty of Joseon Relief Sun",12000,12000,1))
        listPopular.add(PopularModel(R.drawable.recycrelimage3,"Collagen ",3590,3590,1))
        listPopular.add(PopularModel(R.drawable.recycrelimage4,"Doctor Cr.",7610,7610,1))
        listPopular.add(PopularModel(R.drawable.recycrelimage5,"BH serum",8500,8500,1))
        listPopular.add(PopularModel(R.drawable.recycrelimage6,"Baking Powder",4300,4300,1))
        listPopular.add(PopularModel(R.drawable.recycrelimage7,"Zero",5500,5500,1))
        listPopular.add(PopularModel(R.drawable.recycrelimage8,"Joseon Relief Sun serum",2179,2179,1))
        listPopular.add(PopularModel(R.drawable.recycrelimage9,"Hand Cream",3460,3460,1))
        listPopular.add(PopularModel(R.drawable.recycrelimage10,"Peeling Gel",2179,2179,1))
