...
import com.example.finalappcosmeticsstore.databinding.ActivityLocationBinding
...
class LocationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val countryList = arrayOf("Almaty", "Astana", "Taldykorgan","Karagandy")
        val adapter = ArrayAdapter(this@LocationActivity, android.R.layout.simple_expandable_list_item_1,countryList)
